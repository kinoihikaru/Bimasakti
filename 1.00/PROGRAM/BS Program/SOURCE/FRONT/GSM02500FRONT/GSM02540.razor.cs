...
namespace GSM02500FRONT
{
    public partial class GSM02540 : R_Page
    {
        ...
        private string loUnitPromotionTypeLabel = "Active";
        ...
        private async Task Grid_DisplayUnitPromotionType(R_DisplayEventArgs eventArgs)
        {
            if (eventArgs.ConductorMode == R_eConductorMode.Normal)
            {
                ...
                if (loParam.LACTIVE)
                {
                    loUnitPromotionTypeLabel = "Inactive";
                    loUnitPromotionTypeViewModel.SelectedActiveInactiveLACTIVE = false;
                }
                else
                {
                    loUnitPromotionTypeLabel = "Active";
        ...
        private void Grid_BeforeAddUnitPromotionType(R_BeforeAddEventArgs eventArgs)
        {
            UnitPromotionTypeIdRef.FocusAsync();
        }

        private void Grid_BeforeEditUnitPromotionType(R_BeforeEditEventArgs eventArgs)
        {
            UnitPromotionTypeNameRef.FocusAsync();
        }
