    ...
    public partial class LMM01020 : R_Page
    {
        ...
        protected override async Task R_Init_From_Master(object poParameter)
        {
            ...
            try
            {
                ...
                {
                    await RateWG_CheckData(chargesID);
                    await _RateWGDetail_gridRef.R_RefreshGrid(chargesID);
                }
        ...
        private async Task RateWG_CheckData(object poParam)
        {
            ...
            try
            {
                var loParam = new LMM01020DTO();
                loParam.CCHARGES_ID = poParam.ToString();


                var loCheck = await _viewModel.GetRateWGCheckData(loParam);
        ...
        private async Task RateWG_ServiceGetRecord(R_ServiceGetRecordEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                await _viewModel.GetRateWG(loParam);
        ...
        private void RateWGDetail_Saving(R_SavingEventArgs eventArgs)
        {
            ...
            List<LMM01021DTO> Lodata = (List<LMM01021DTO>)eventArgs.Data;
            _viewModel.Data.CRATE_WG_LIST = Lodata;
        }
    }
}
