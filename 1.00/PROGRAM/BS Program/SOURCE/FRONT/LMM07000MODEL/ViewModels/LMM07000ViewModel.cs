        ...
        public async Task ChargesDiscountValidation(LMM07000DTO poParam)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        loEx.Add("7014", string.Format(R_FrontUtility.R_GetMessage(typeof(Resources_Dummy_Class), "7014"), MaxPeriod.INO_PERIOD));
                    }
                    ...
                    {
                        loEx.Add("7015", string.Format(R_FrontUtility.R_GetMessage(typeof(Resources_Dummy_Class), "7015"), MaxPeriod.INO_PERIOD));
                    }
                }
            }
            catch (Exception ex)
