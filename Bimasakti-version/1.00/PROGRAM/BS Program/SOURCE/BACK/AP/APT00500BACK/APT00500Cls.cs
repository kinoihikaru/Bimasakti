...
namespace APT00500BACK
{
    public class APT00500Cls : R_BusinessObject<APT00500DTO>
    {
        ...
        public APT00500Cls()
        {
            ...
            _activitySource = APT00500ActivitySourceBase.R_GetInstanceActivitySource();
        }

        public List<APT00500DTO> GetAllPurchaseAdjustment(APT00500ParamDTO poEntity)
        {
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<APT00500DTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override APT00500DTO R_Display(APT00500DTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("R_Display");
            var loEx = new R_Exception();
            APT00500DTO loResult = null;
            ...
            try
            {
             ...
             .Where(x => x != null && x.ParameterName.StartsWith("@")).Select(x => x.Value);
                ...
                loResult = R_Utility.R_ConvertTo<APT00500DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override void R_Saving(APT00500DTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var loResult = R_Utility.R_ConvertTo<APT00500DTO>(loDataTable).FirstOrDefault();
        ...
        protected override void R_Deleting(APT00500DTO poEntity)
        {
        ...
        public void SubmitPurchaseAdjustment(APT00500SubmitRedraftDTO poEntity)
        {
        ...
        public void RedraftPurchaseAdjustment(APT00500SubmitRedraftDTO poEntity)
        {
