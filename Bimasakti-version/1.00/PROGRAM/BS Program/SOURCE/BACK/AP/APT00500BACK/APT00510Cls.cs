...
{
    public class APT00510Cls : R_BusinessObject<APT00510DTO>
    {
        ...
        public APT00510Cls()
        {
            ...
            _activitySource = APT00510ActivitySourceBase.R_GetInstanceActivitySource();
        }

        public List<APT00510DTO> GetAllPurchaseAdjustmentAlloc(APT00510DTO poEntity)
        {
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<APT00510DTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override APT00510DTO R_Display(APT00510DTO poEntity)
        {
            using Activity activity = _activitySource.StartActivity("R_Display");
            var loEx = new R_Exception();
            APT00510DTO loResult = null;
            ...
            try
            {
             ...
             .Where(x => x != null && x.ParameterName.StartsWith("@")).Select(x => x.Value);
                ...
                loResult = R_Utility.R_ConvertTo<APT00510DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override void R_Saving(APT00510DTO poNewEntity, eCRUDMode poCRUDMode)
        {
        ...
        protected override void R_Deleting(APT00510DTO poEntity)
        {
