...
{
    public class LMM04020Cls
    {
        public LoggerLMM04020 _logger;
        public LMM04020Cls() 
        {
            _logger = LoggerLMM04020.R_GetInstanceLogger();
        }
        public LMM04020DTO GetTaxInfo(LMM04020ParameterDTO poEntity)
        {
            R_Exception loException = new R_Exception();
            LMM04020DTO loResult = null;
            R_Db loDb = new R_Db();
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<LMM04020DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        public List<GetLMM04020ListDTO> GetTaxTypeList(GetLMM04020ListParameterDTO poEntity)
        {
            R_Exception loException = new R_Exception();
            ...
            try
            {
                ...
                var loDebugLogResult = string.Format("SELECT * FROM " +
                ...
                loResult = R_Utility.R_ConvertTo<GetLMM04020ListDTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loException.Add(ex);
        ...
        public List<GetLMM04020ListDTO> GetIdTypeList(GetLMM04020ListParameterDTO poEntity)
        {
            R_Exception loException = new R_Exception();
            List<GetLMM04020ListDTO> loResult = null;
            R_Db loDb = new R_Db();
            ...
            try
            {
                ...
                var loDebugLogResult = string.Format("SELECT * FROM " +
                    "RFT_GET_GSB_CODE_INFO('BIMASAKTI', {0} , " +
                    "'_BS_ID_TYPE', '' , {1}) || GetTaxTypeList(Cls)", loCompanyIdLog, loUserLanLog);
                _logger.LogDebug(loDebugLogResult);
        ...
        public List<GetLMM04020ListDTO> GetTaxCodeList(GetLMM04020ListParameterDTO poEntity)
        {
            R_Exception loException = new R_Exception();
            List<GetLMM04020ListDTO> loResult = null;
            R_Db loDb = new R_Db();
            ...
            try
            {
                ...
                var loDebugLogResult = string.Format("SELECT CCODE, CDESCRIPTION FROM " +
                    "RFT_GET_GSB_CODE_INFO('BIMASAKTI', {0} , " +
                    "'_TAX_CODE', '' , {1}) || GetTaxTypeList(Cls)", loCompanyIdLog, loUserLanLog);
                _logger.LogDebug(loDebugLogResult);
