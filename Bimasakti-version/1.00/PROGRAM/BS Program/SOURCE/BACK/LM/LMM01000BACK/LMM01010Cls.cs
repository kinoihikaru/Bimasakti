    ...
    public class LMM01010Cls : R_BusinessObject<LMM01010DTO>, R_IBatchProcess
    {
        ...
        public List<LMM01011DTO> GetAllRateECList(LMM01011DTO poEntity)
        {
            ...
            try
            {
                ...
                _LMM01010logger.LogDebug("EXEC RSP_LM_GET_RATE_EC_LIST {@poParameter}", loDbParam);
        ...
        protected override LMM01010DTO R_Display(LMM01010DTO poEntity)  
        {
            ...
            try
            {
                ...
                var loDbParam = loCmd.Parameters.Cast<DbParameter>()
                 .Where(x => x != null && x.ParameterName.StartsWith("@")).Select(x => x.Value);
                _LMM01010logger.LogDebug("EXEC RSP_LM_GET_CHARGES_UTILITY_RATE_EC {@poParameter}", loDbParam);
        ...
        public LMM01010DTO GetBaseHeaderLogoCompany(LMM01010PrintParamDTO poEntity)
        {
            ...
            try
            {
                ...
                var loDbParam = loCmd.Parameters.Cast<DbParameter>()
                .Where(x => x != null && x.ParameterName.StartsWith("@")).Select(x => x.Value);
                _LMM01010Printlogger.LogDebug("SELECT dbo.RFN_GET_COMPANY_LOGO({@CCOMPANY_ID}) as CLOGO", loDbParam);
            ...
            {
                loEx.Add(ex);
                _LMM01010Printlogger.LogError(loEx);
            }
        ...
        public LMM01010DTO GetHDReportRateEC(LMM01010DTO poEntity)
        {
            ...
            try
            {
                ...
                var loDbParam = loCmd.Parameters.Cast<DbParameter>()
                 .Where(x => x != null && x.ParameterName.StartsWith("@")).Select(x => x.Value);
                _LMM01010Printlogger.LogDebug("EXEC RSP_LM_GET_CHARGES_UTILITY_RATE_EC {@poParameter}", loDbParam);
        ...
        public List<LMM01011DTO> GetDetailReportRateEC(LMM01011DTO poEntity)
        {
            ...
            try
            {
                ...
                var loDbParam = loCmd.Parameters.Cast<DbParameter>()
                 .Where(x => x != null && x.ParameterName.StartsWith("@")).Select(x => x.Value);
                _LMM01010Printlogger.LogDebug("EXEC RSP_LM_GET_RATE_EC_LIST {@poParameter}", loDbParam);
