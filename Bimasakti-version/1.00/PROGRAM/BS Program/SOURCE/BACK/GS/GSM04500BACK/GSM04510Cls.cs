...
namespace GSM04500BACK
{
    ...
    {
        public List<GSM04510DTO> GetAllJournalGroupGOA(GSM04510ParameterDTO poEntity)
        {
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<GSM04510DTO>(loDataTable).ToList();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override void R_Deleting(GSM04510DTO poEntity)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@LLDEPARTMENT_MODE", DbType.Boolean, 50, poEntity.LDEPARTMENT_MODE);
        ...
        protected override GSM04510DTO R_Display(GSM04510DTO poEntity)
        {
            ...
            try
            {
                ...
                loResult = R_Utility.R_ConvertTo<GSM04510DTO>(loDataTable).FirstOrDefault();
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        protected override void R_Saving(GSM04510DTO poNewEntity, eCRUDMode poCRUDMode)
        {
            ...
            try
            {
                ...
                loDb.R_AddCommandParameter(loCmd, "@LLDEPARTMENT_MODE", DbType.Boolean, 50, poNewEntity.LDEPARTMENT_MODE);
