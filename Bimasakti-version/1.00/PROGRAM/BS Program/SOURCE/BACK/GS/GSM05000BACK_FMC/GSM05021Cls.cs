...
public class GSM05021Cls : R_BusinessObject<GSM05021DTO>
{
    ...
    public List<GSM05021DTO> GetApprovaReplacelListDb(GSM05021DTO poParameter)
    {
        R_Exception loEx = new();
        List<GSM05021DTO> loRtn = null;
        R_Db loDb;
        DbConnection loConn;
        DbCommand loCmd;
        string lcQuery;
        ...
        try
        {
            ...
            loRtn = R_Utility.R_ConvertTo<GSM05021DTO>(loDataTable).ToList();
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    protected override void R_Deleting(GSM05021DTO poEntity)
    {
        R_Exception loEx = new();
        string lcQuery;
        R_Db loDb;
    ...
    protected override GSM05021DTO R_Display(GSM05021DTO poEntity)
    {
        R_Exception loEx = new();
        GSM05021DTO loRtn = null;
        R_Db loDb;
        DbConnection loConn;
        DbCommand loCmd;
        string lcQuery;
        try
        {
            ...
            loRtn = R_Utility.R_ConvertTo<GSM05021DTO>(loDataTable).FirstOrDefault();
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    protected override void R_Saving(GSM05021DTO poNewEntity, eCRUDMode poCRUDMode)
    {
        R_Exception loEx = new();
        string lcQuery;
        R_Db loDb;
