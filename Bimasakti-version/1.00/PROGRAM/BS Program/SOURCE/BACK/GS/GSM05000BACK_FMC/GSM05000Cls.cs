...
public class GSM05000Cls : R_BusinessObject<GSM05000DTO>
{
    ...
    public List<GSM05000DTO> GetTransactionCodeListDb()
    {
        R_Exception loEx = new();
        List<GSM05000DTO> loRtn = null;
        R_Db loDb;
        DbConnection loConn;
        DbCommand loCmd;
        string lcQuery;
        try
        {
            ...
            lcQuery = $"EXEC RSP_GS_GET_TRANS_CODE_LIST @CCOMPANY_ID, @CUSER_ID";
            loCmd.CommandType = CommandType.Text;
            loCmd.CommandText = lcQuery;

            loDb.R_AddCommandParameter(loCmd, "@CCOMPANY_ID", DbType.String, 10, R_BackGlobalVar.COMPANY_ID);
            ...
            loRtn = R_Utility.R_ConvertTo<GSM05000DTO>(loDataTable).ToList();
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
    ...
    public GSM05000ValidateDTO GetValidateUpdateDb(GSM05000ValidateDTO poEntity)
    {
        R_Exception loEx = new();
        GSM05000ValidateDTO loRtn = null;
        R_Db loDb;
        DbConnection loConn;
        DbCommand loCmd;
        string lcQuery = null;
        try
        {
            ...
            if (poEntity.ETAB_INDEX == GSM05000eTabName.Numbering)
            {
            ...
            else if (poEntity.ETAB_INDEX == GSM05000eTabName.Approval)
            {
                lcQuery = @"select top 1 1 as EXIST 
            ...
            loRtn = R_Utility.R_ConvertTo<GSM05000ValidateDTO>(loDataTable).FirstOrDefault();
        }
        catch (Exception ex)
        {
            loEx.Add(ex);
