...
{
    public class GLT00500ValidateUploadCls : R_IBatchProcess
    {
        public void R_BatchProcess(R_BatchProcessPar poBatchProcessPar)
        {
            ...
            try
            {
                ...
                var loTempObject = R_NetCoreUtility.R_DeserializeObjectFromByte<ImportAdjustmentJournalParameterDTO>(poBatchProcessPar.BigObject);

                loResult = new List<GetImportAdjustmentJournalResult>();
                ...
                loResult = R_Utility.R_ConvertTo<GetImportAdjustmentJournalResult>(loDataTable).ToList();
                ...
                loDb.R_BulkInsert<GetImportAdjustmentJournalResult>((SqlConnection)loConn, "#JOURNAL_RESULT", loResult);
