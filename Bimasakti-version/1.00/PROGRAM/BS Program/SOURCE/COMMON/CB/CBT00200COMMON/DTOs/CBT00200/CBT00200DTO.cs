...
namespace CBT00200COMMON
{
    public class CBT00200DTO
    {
        ...
        public DateTime DREF_DATE { get => dREF_DATE; set => dREF_DATE = DateTime.TryParseExact(CREF_DATE, "yyyyMMdd", CultureInfo.InvariantCulture, DateTimeStyles.AssumeUniversal, out var ldDocDate) ? ldDocDate : DateTime.MinValue; }
