...
{
    public class LMM01020SaveBatchViewModel : R_IProcessProgressStatus
    {
        private string Message;
        private int Percentage;
        public async Task SaveRateWG(LMM01020DTO poNewEntity, eCRUDMode peCRUDMode, string pcCompanyId, string pcUserId)
        {
            ...
            { 
                ...
                loUploadPar.ClassName = "LMM01000BACK.LMM01020Cls";
                ...
                var loKeyGuid = await loCls.R_BatchProcess<LMM01020DTO>(loUploadPar, 5);
            } catch (Exception ex)
            {
                loEx.Add(ex);
            }
        ...
        private async Task ServiceGetError(string pcKeyGuid)
        {
            ...
            try
            {
                ...
                loParameterData = new R_GetErrorWithMultiLanguageParameter()
                {
                    ...
                    USER_ID = UserId,
                    KEY_GUID = pcKeyGuid,
                    RESOURCE_NAME = "RSP_LM_MAINTAIN_RATE_WGResources"
                };
