...
{
    public class LMM01010SaveBatchViewModel : R_IProcessProgressStatus
    {
        ...
        public async Task SaveRateEC(LMM01010DTO poNewEntity, eCRUDMode peCRUDMode, string pcCompanyId, string pcUserId)
        {
            ...
            try
            {
                ...
                var loKeyGuid = await loCls.R_BatchProcess<LMM01010DTO>(loUploadPar, 5);
            } catch (Exception ex)
            {
                loEx.Add(ex);
            }
        ...
        private async Task ServiceGetError(string pcKeyGuid)
        {
            ...
            try
            {
                ...
                loParameterData = new R_GetErrorWithMultiLanguageParameter()
                {
                    ...
                    USER_ID = UserId,
                    KEY_GUID = pcKeyGuid,
                    RESOURCE_NAME = "RSP_LM_MAINTAIN_RATE_ECResources"
                };
