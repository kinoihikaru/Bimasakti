...
namespace LMM01000MODEL
{
    public class LMM01000UniversalModel : R_BusinessObjectServiceClientBase<LMM01000DTO>, ILMM01000Universal
    {
        ...
        public async Task<List<LMM01000DTOPropety>> GetPropertyAsync()
        {
            ...
            try
            {
                ...
                loRtn = await R_HTTPClientWrapper.R_APIRequestStreamingObject<LMM01000DTOPropety>(
                    ...
                    nameof(ILMM01000Universal.GetProperty),
                    DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken);
            }
        ...
        public async Task<LMM01000AllResultInit> GetAllInitLMM01000ListAsync()
        {
            var loEx = new R_Exception();
            LMM01000AllResultInit loRtn = null;

            try
            {
                R_HTTPClientWrapper.httpClientName = _HttpClientName;

                loRtn = await R_HTTPClientWrapper.R_APIRequestObject<LMM01000AllResultInit>(
                    _RequestServiceEndPoint,
                    nameof(ILMM01000Universal.GetAllInitLMM01000List),
                    DEFAULT_MODULE,
                    _SendWithContext,
                    _SendWithToken);
            }
