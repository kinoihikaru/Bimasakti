...
namespace GSM02500FRONT
{
    public partial class GSM02530 : R_Page
    {
        ...
        private string loUnitInfoLabel = "Active";

        private string lcCUOMLabel;

        private R_TextBox UnitInfoUnitIdRef;
        ...
        private void Grid_BeforeAddUnitInfo(R_BeforeAddEventArgs eventArgs)
        {
            UnitInfoUnitIdRef.FocusAsync();
        }
