...
public partial class GSM05022 : R_Page
{
    ...
    protected override async Task R_Init_From_Master(object poParameter)
    {
        ...
        try
        {
            _deptViewModel.ToDept = (GSM05020DeptDTO)poParameter;
    ...
    private void AfterOpenLookup(R_AfterOpenLookupEventArgs eventArgs)
    {
        ...
        _deptViewModel.FromDept.CDEPT_CODE = loData.CDEPT_CODE;
        _deptViewModel.FromDept.CDEPT_NAME = loData.CDEPT_NAME;
    }

    public async Task Button_OnClickProcessAsync()
    {
        var loData = _deptViewModel.FromDept;
