...
namespace LMM06500MODEL
{
    public class LMM06500UniversalViewModel
    {
        ...
        public async Task GetPositionList(LMM06500UniversalDTO poParam)
        {
            ...
            try
            {
                var loResult = await _LMM06500UniversalModel.GetPositionListAsync();
        ...
        public async Task GetGenderList(LMM06500UniversalDTO poParam)
        {
            ...
            try
            {
                var loResult = await _LMM06500UniversalModel.GetGenderListAsync();
        ...
        public async Task GetPropertyList()
        {
            ...
            try
            {
                var loResult = await _LMM06500UniversalModel.GetPropertyAsync();
