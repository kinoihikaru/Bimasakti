    ...
    public partial class APT00620 : R_Page
    {
        ...
        protected override async Task R_Init_From_Master(object poParameter)
        {
            ...
            try
            {
                ...
                var loHeaderData = (APT00600DTO)poParameter;
        ...
        protected async override Task<bool> R_LockUnlock(R_LockUnlockEventArgs eventArgs)
        {
            ...
            try
            {
                var loData = (APT00610DTO)eventArgs.Data;
        ...
        private async Task PurchAdjAlloc_ServiceGetRecord(R_ServiceGetRecordEventArgs eventArgs)
        {
            ...
            try
            {
                var loParam = (APT00610DTO)eventArgs.Data;
        ...
        private async Task PurchAdjAlloc_ServiceDelete(R_ServiceDeleteEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModel.DeletePurchaseAdjustmentAlloc((APT00610DTO)eventArgs.Data);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        private async Task PurchAdjAlloc_ServiceSave(R_ServiceSaveEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModel.SavePurchaseAdjustmentAlloc((APT00610DTO)eventArgs.Data, (eCRUDMode)eventArgs.ConductorMode);
        ...
        private async Task R_After_Open_LookupReferenceNo(R_AfterOpenLookupEventArgs eventArgs)
        {
            ...
            var loData = (APT00610DTO)_conRef.R_GetCurrentData();
