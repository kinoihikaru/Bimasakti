...
namespace APT00500FRONT
{
    public partial class APT00510 : R_Page
    {
        ...
        protected async override Task<bool> R_LockUnlock(R_LockUnlockEventArgs eventArgs)
        {
            ...
            try
            {
                var loData = (APT00500DTO)eventArgs.Data;
        ...
        private async Task PurchAdj_ServiceGetRecord(R_ServiceGetRecordEventArgs eventArgs)
        {
            ...
            try
            {
                var loData = R_FrontUtility.ConvertObjectToObject<APT00500DTO>(eventArgs.Data);
        ...
        private async Task PurchAdj_ServiceSave(R_ServiceSaveEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModel.SavePurchaseAdjustment((APT00500DTO)eventArgs.Data, (eCRUDMode)eventArgs.ConductorMode);
        ...
        private async Task PurchAdj_ServiceDelete(R_ServiceDeleteEventArgs eventArgs)
        {
            ...
            try
            {
                await _viewModel.DeletePurchaseAdjustment((APT00500DTO)eventArgs.Data);
            }
            catch (Exception ex)
            {
                loEx.Add(ex);
        ...
        private async Task PurchAdjAlloc_ServiceGetListRecord(R_ServiceGetListRecordEventArgs eventArgs)
        {
            ...
            try
            {
                var loData = R_FrontUtility.ConvertObjectToObject<APT00510DTO>(eventArgs.Parameter);
        ...
        private async Task SubmitPurchaseAdjProcess()
        {
            ...
            try
            {
                ...
                if (loValidate == R_eMessageBoxResult.Yes)
                {
                    ...
                    var loParam = R_FrontUtility.ConvertObjectToObject<APT00500SubmitRedraftDTO>(loData);
        ...
        private void R_Before_Open_PopupAllocate(R_BeforeOpenPopupEventArgs eventArgs)
        {
            ...
            eventArgs.Parameter = loParam;
            eventArgs.TargetPageType = typeof(APT00520);
        }
