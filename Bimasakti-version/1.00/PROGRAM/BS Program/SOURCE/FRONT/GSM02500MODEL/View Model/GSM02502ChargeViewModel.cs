...
namespace GSM02500MODEL.View_Model
{
    public class GSM02502ChargeViewModel : R_ViewModel<GSM02502ChargeDTO>
    {
        ...
        public async Task GetChargeListStreamAsync()
        {
            ...
            try
            {
                R_FrontContext.R_SetStreamingContext(ContextConstant.GSM02502_CHARGE_PROPERTY_ID_STREAMING_CONTEXT, SelectedProperty);
                R_FrontContext.R_SetStreamingContext(ContextConstant.GSM02502_CHARGE_UNIT_TYPE_CATEGORY_ID_STREAMING_CONTEXT, SelectedUnitTypeCategory);
